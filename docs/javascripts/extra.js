...
(function() {
  ...
  versionWarning.style.cssText = 'display:none;background:#fff3cd;padding:1rem;margin:1rem 0;border-radius:0.5rem;border-left:4px solid #ffc107;';
  versionWarning.innerHTML = '<strong>⚠️ Note:</strong> You are viewing documentation for an older version. <a href="/latest/">View latest version</a>';
