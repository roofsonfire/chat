...
- `README.md` – High-level overview, quick start, and architecture snapshot. Keep it concise and link out instead of duplicating detail.
- `docs/README.md` – Canonical documentation index. Follow the section structure (Getting Started, Build & Architecture, AI & Data, Security, Operations, etc.) when adding or referencing guides.
- `docs/CONTRIBUTING-DOCS.md` – Rules for naming, linking, and maintaining documentation. Review this before creating or relocating files.
- For deep dives, link to the specific guide rather than copying content into this instructions file. Key entry points:
  - Development workflows: `docs/DEVELOPMENT.md`, `docs/EDITOR-SETUP.md`
  - Architecture and services: `docs/PROJECT-NAVIGATION.md`, `docs/API.md`, `docs/PERFORMANCE.md`
  - Deployment runbooks: `docs/deployment/`
  - Security posture: `docs/USER-MANAGEMENT.md`, `docs/features/MIDDLEWARE-SECURITY-SUMMARY.md`, `docs/SECURITY.md`
- If documentation moves, update both `docs/README.md` and this section to keep AI suggestions aligned with the source of truth.
