        ...
        <CardContent className="pt-[var(--spacing-6)]">
          <div className="flex items-start gap-[var(--spacing-3)]">
            ...
            <div className="flex gap-[var(--spacing-1)]">
              <Skeleton className="h-[var(--spacing-2)] w-[var(--spacing-2)] rounded-full animate-pulse" />
              <Skeleton className="h-[var(--spacing-2)] w-[var(--spacing-2)] rounded-full animate-pulse [animation-delay:0.2s]" />
              <Skeleton className="h-[var(--spacing-2)] w-[var(--spacing-2)] rounded-full animate-pulse [animation-delay:0.4s]" />
            </div>
          </div>
        </CardContent>
      </Card>
