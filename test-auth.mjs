...
const AUTH_USER_EMAIL = 'juanmanueldaza@gmail.com';
const AUTH_USER_PASSWORD_HASH = '$2b$10$hvBcdqhSx.L0nsCKGIgM9udmXwurFH28QclEecsKRoKTzE1DZYy4S';

// Test credentials
const testEmail = 'juanmanueldaza@gmail.com';
...
const passwordMatch = await bcrypt.compare(testPassword, AUTH_USER_PASSWORD_HASH);
